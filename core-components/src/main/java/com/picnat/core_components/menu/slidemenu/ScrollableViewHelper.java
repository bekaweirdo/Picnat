...
public class ScrollableViewHelper {
    /**
     * Returns the current scroll position of the scrollable pointView. If this method returns zero or
     * less, it means at the scrollable pointView is in a position such as the panel should handle
     * scrolling. If the method returns anything above zero, then the panel will let the scrollable
     * pointView handle the scrolling
     *
